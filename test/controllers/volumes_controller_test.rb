...
class VolumesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create volume" do
    assert_difference('Volume.count') do
      post volumes_url, params: { volume: { data: @volume.data, nome: @volume.nome, nota: @volume.nota, quantidade: @volume.quantidade, valor: @volume.valor } }
    end
  ...
  test "should update volume" do
    patch volume_url(@volume), params: { volume: { data: @volume.data, nome: @volume.nome, nota: @volume.nota, quantidade: @volume.quantidade, valor: @volume.valor } }
