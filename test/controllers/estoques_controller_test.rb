...
class EstoquesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create estoque" do
    assert_difference('Estoque.count') do
      post estoques_url, params: { estoque: { compra: @estoque.compra, custo: @estoque.custo, nota: @estoque.nota, produto: @estoque.produto, quantidade: @estoque.quantidade, validade: @estoque.validade } }
    end
  ...
  test "should update estoque" do
    patch estoque_url(@estoque), params: { estoque: { compra: @estoque.compra, custo: @estoque.custo, nota: @estoque.nota, produto: @estoque.produto, quantidade: @estoque.quantidade, validade: @estoque.validade } }
