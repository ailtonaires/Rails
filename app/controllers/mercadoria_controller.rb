class MercadoriaController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @mercadorium.save
        ...
        format.json { render :show, status: :created, location: @mercadorium }
      else
  ...
  def update
    respond_to do |format|
      if @mercadorium.update(mercadorium_params)
        ...
        format.json { render :show, status: :ok, location: @mercadorium }
      else
  ...
  def destroy
    @mercadorium.destroy
    respond_to do |format|
      format.html { redirect_to mercadoria_url, notice: 'Mercadorium was successfully destroyed.' }
  ...
  private
    ...
    def mercadorium_params
      params.require(:mercadorium).permit(:nome, :quantidade, :valor, :data, :nota)
    end
end
